...
public class MyCatalogs {
	...
	private ArrayList<MyOrder> fororder = new ArrayList<MyOrder>();
	private ArrayList<MySale> forsale = new ArrayList<MySale>();
	...
	// Fills the "availables" list with the products the store sells 
	public void addAll(){
		// Motherboards
