...
ALTER TABLE Listings_copy DROP COLUMN host_since;
ALTER TABLE Listings_copy DROP COLUMN host_location;
ALTER TABLE Listings_copy DROP COLUMN host_about;
ALTER TABLE Listings_copy DROP COLUMN host_response_time;
ALTER TABLE Listings_copy DROP COLUMN host_acceptance_rate;
ALTER TABLE Listings_copy DROP COLUMN host_is_superhost;
ALTER TABLE Listings_copy DROP COLUMN host_thumbnail_url;
ALTER TABLE Listings_copy DROP COLUMN host_picture_url;
ALTER TABLE Listings_copy DROP COLUMN host_neighbourhood;
ALTER TABLE Listings_copy DROP COLUMN host_listings_count;
ALTER TABLE Listings_copy DROP COLUMN host_total_listings_count;
ALTER TABLE Listings_copy DROP COLUMN host_verifications;
ALTER TABLE Listings_copy DROP COLUMN host_has_profile_pic;
ALTER TABLE Listings_copy DROP COLUMN host_identity_verified;
ALTER TABLE Listings_copy DROP COLUMN calculated_host_listings_count;
ALTER TABLE Listings_copy DROP COLUMN host_name;
ALTER TABLE Listings_copy DROP COLUMN host_response_rate;
