...
1)Ανάμεσα στην σύνδεση Wi-Fi και 4G σε public broker βλέπουμε πως το 4G είναι πιο γρήγορο.
2)Ανάμεσα σε τοπικό και public broker βλέπουμε μια τεράστια διαφορά για τόσο μικρό όγκο δεδομένων
3)Γενικά: Public-Wi-Fi > Public-4G > Local-Wi-fi
4)Στον local broker με σύνδεση 4G είναι N/A καθώς δεν μπορεί να localhost broker με σύνδεση στα data
